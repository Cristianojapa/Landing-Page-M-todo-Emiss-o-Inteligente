      ...
      <div className="container relative">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[0.85fr_1.15fr]">
          <Reveal className="premium-panel rounded-[32px] p-6 md:p-8">
            ...
            <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-gold/30 bg-gold/10 px-4 py-2 text-sm font-semibold text-gold md:mt-8">
                  ...
                  >
                    <CarouselContent className="-ml-2 md:-ml-4">
                      {carouselItems.map((img, index) => (
                        <CarouselItem key={`${img}-${index}`} className="pl-2 basis-[85%] sm:basis-1/2 md:pl-4 xl:basis-1/3">
                          <div className="elevated-card group h-full rounded-[26px] p-2 md:p-3">
